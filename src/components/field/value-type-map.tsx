...
export const valueTypeToComponentMap: Record<string, ProRenderFieldPropsType> =
  {
    ...
    cascader: {
      render: (modelValue, props) => (
        <FieldCascader v-model={modelValue} {...props} />
      ),
      formItemRender: (modelValue, props) => (
    ...
    treeSelect: {
      render: (modelValue, props) => (
        <FieldTreeSelect v-model={modelValue} {...props} />
      ),
      formItemRender: (modelValue, props) => (
    ...
    code: {
      render: (modelValue, props) => (
        <FieldCode v-model={modelValue} {...props} />
      ),
      formItemRender: (modelValue, props) => (
    ...
    jsonCode: {
      render: (modelValue, props) => (
        <FieldCode v-model={modelValue} language="json" {...props} />
      ),
      formItemRender: (modelValue, props) => (
        <FieldCode
          v-model={modelValue}
    ...
    color: {
      render: (modelValue, props) => (
        <FieldColorPicker v-model={modelValue} {...props} />
      ),
      formItemRender: (modelValue, props) => (
    ...
    digitRange: {
      render: (modelValue, props) => (
        <FieldDigitRange v-model={modelValue} {...props} />
      ),
      formItemRender: (modelValue, props) => (
    ...
    fromNow: {
      render: (modelValue, props) => (
        <FieldFromNow v-model={modelValue} {...props} />
      ),
      formItemRender: (modelValue, props) => (
    ...
    image: {
      render: (modelValue, props) => (
        <FieldImage v-model={modelValue} {...props} />
      ),
      formItemRender: (modelValue, props) => (
    ...
    index: {
      render: (modelValue, props) => (
        <FieldIndexColumn v-model={modelValue} {...props} />
      ),
      formItemRender: (modelValue, props) => (
        <FieldIndexColumn v-model={modelValue} {...props} />
      ),
    ...
    progress: {
      render: (modelValue, props) => (
        <FieldProgress v-model={modelValue} {...props} />
      ),
      formItemRender: (modelValue, props) => (
    ...
    second: {
      render: (modelValue, props) => (
        <FieldSecond v-model={modelValue} {...props} />
      ),
      formItemRender: (modelValue, props) => (
    ...
    segmented: {
      render: (modelValue, props) => (
        <FieldSegmented v-model={modelValue} {...props} />
      ),
      formItemRender: (modelValue, props) => (
    ...
    option: {
      render: (modelValue, props) => (
        <FieldOptions v-model={modelValue} {...props} />
      ),
      formItemRender: (modelValue, props) => (
        <FieldOptions v-model={modelValue} {...props} />
      ),
