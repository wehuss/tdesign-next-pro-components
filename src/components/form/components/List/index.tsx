...
export const FormListContextKey: InjectionKey<FormListContextValue> =
  ...
  props: {
    ...
    creatorButtonProps: {
      type: [Object, Boolean] as PropType<
        ProFormListProps["creatorButtonProps"]
      >,
      default: () => ({
    ...
    itemContainerRender: Function as PropType<
      ProFormListProps["itemContainerRender"]
    >,
    ...
    fieldExtraRender: Function as PropType<
      ProFormListProps["fieldExtraRender"]
    >,
  ...
  setup(props, { slots }) {
    ...
    const renderActionButtons = (
      ...
      if (props.deleteIconProps !== false && canDelete.value) {
        ...
        actions.push(
          <Tooltip
            content={deleteConfig.tooltipText || "删除此项"}
            key="delete"
          >
            <span
              class="pro-form-list-action-icon action-remove"
    ...
    const renderListItem = (item: ListItem, index: number) => {
      ...
      if (props.itemContainerRender) {
        itemContainer = props.itemContainerRender(
          children as VNode[],
          listMeta
        );
      }
