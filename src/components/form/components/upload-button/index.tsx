...
/**
 * ProFormUploadButton 组件
 * 上传按钮表单字段，使用 TDesign Upload 组件
 */
export const ProFormUploadButton = defineComponent({
  ...
  props: {
    ...
    max: Number, // maxCount in TDesign is max
    limit: Number, // Deprecated or duplicate? TDesign has max.
    // fieldProps specific to Upload
    fieldProps: {
